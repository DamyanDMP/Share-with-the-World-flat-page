...
<br/><br/>
        ...
        <div class=\"background-image-holder\">
            <img class=\"background-image\" alt=\"Poster Image For Mobiles\" src=\"/css/img/login.jpg\">
        </div>
            ...
            <div class=\"row\">
                <div class=\"col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 text-center\">
                    ...
                    <div class=\"photo-form-wrapper clearfix\">
                        <form id=\"loginForm\">
                            <input id=\"email\" name=\"loginEmail\" class=\"form-email\" type=\"text\" placeholder=\"Email Address\" value=\"damyan@gmail.com\">
                            <div style=\"display: none\" id=\"error-email\" class=\"alert alert-danger\" role=\"alert\"></div>
                            <input id=\"password\" name=\"loginPassword\"class=\"form-password\" type=\"password\" placeholder=\"Password\" value=\"asdasd\">
