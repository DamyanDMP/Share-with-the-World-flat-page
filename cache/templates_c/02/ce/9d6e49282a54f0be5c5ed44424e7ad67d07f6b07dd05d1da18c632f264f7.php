...
<div class=\"main-container\">
    <header class=\"signup\">
        <div class=\"background-image-holder parallax-background\">
            <img class=\"background-image\" alt=\"Background Image\" src=\"/css/img/login.jpg\">
        </div>

        <div class=\"container\">
            <div class=\"row\">
                <div class=\"col-md-10 col-md-offset-1 col-sm-12 text-center\">
                    <h1 class=\"text-white\">Welcome to our amazing new service <br>sign up now and experience the pure goodness<br/>";
        // line 12
                    ...
                    <div class=\"photo-form-wrapper clearfix\">
                        ...
                        <div class=\"row\">
                            <div class=\"col-md-3 col-sm-4\">
                                <input value=\"damyan@gmail.com\" id=\"email\" class=\"form-email\" type=\"text\" name=\"email\" placeholder=\"Email Address\">
                                <div style=\"display: none\" id=\"error-email\" class=\"alert alert-danger\" role=\"alert\"></div>
                            </div>

                            <div class=\"col-md-3 col-sm-4\">
                                <input value=\"asdasd\" id=\"password\" class=\"form-password\" type=\"password\" name=\"password\" placeholder=\"Password\" >
                                <div style=\"display: none\" id=\"error-password\" class=\"alert alert-danger\" role=\"alert\"></div>
                            </div>

                            <div class=\"col-md-3 col-sm-4\">
                                <input value=\"asdasd\" id=\"confirm-password\" class=\"form-password2\" type=\"password\" name=\"confirm-password\" placeholder=\"Confirm Password\">
...
";
    ...
    {
        return array (  81 => 54,  79 => 53,  33 => 12,  21 => 2,  19 => 1,);
    }
}
